...
There ia a batch script for removing _ suffix from a file in a particular file location, you can change the location as per your need.
There is a batch script for adding a prefix D in front of all the files in a particular location, you can change the prefix and the location of your files as per your need.
There is an excel with a macro that can copy all the files from source folder to the destination folder as mentioned in the excel. you can replace the file path as per your need.
